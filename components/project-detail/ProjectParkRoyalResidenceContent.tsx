...
import { PARK_ROYAL_RESIDENCE_MEDIA } from "@/lib/park-royal-residence-media";
import { getTranslations } from "next-intl/server";
import type { IconType } from "react-icons";
import { MdPark, MdShoppingBag } from "react-icons/md";
import { TbRulerMeasure } from "react-icons/tb";

type StatItem = { value: string; label: string; detail: string };

const STAT_ICONS: IconType[] = [TbRulerMeasure, MdShoppingBag, MdPark];

export async function ProjectParkRoyalResidenceContent() {
  const t = await getTranslations("ProjectParkRoyal");
    ...
    >
      <RevealFadeUp>
        <section
          ...
          aria-labelledby="parkroyal-stats-heading"
        >
          <div className="mx-auto max-w-5xl">
            <h2 id="parkroyal-stats-heading" className="sr-only">
              {t("statsSectionLabel")}
            </h2>
        ...
        <section className="px-6 py-16 lg:px-10 lg:py-24">
          <div className="mx-auto grid max-w-[1200px] gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
            ...
            <div className="relative aspect-[4/3] overflow-hidden bg-[#d1dfdf]/50">
              <img
                src={PARK_ROYAL_RESIDENCE_MEDIA.concept}
        ...
        <section className="border-t border-[#d1dfe0] bg-[#eef4f4]/40 px-6 py-16 lg:px-10 lg:py-24">
          <div className="mx-auto grid max-w-[1200px] gap-12 lg:grid-cols-2 lg:items-center lg:gap-16">
            <div className="relative order-2 aspect-[4/3] overflow-hidden bg-[#d1dfdf]/50 lg:order-1">
              <img
                src={PARK_ROYAL_RESIDENCE_MEDIA.architecture}
                alt={t("archImageAlt")}
                width={1200}
                height={900}
                className="h-full w-full object-cover"
      ...
      <RevealFadeUp>
        <section className="px-6 py-16 lg:px-10 lg:py-24">
          <div className="mx-auto max-w-[1200px]">
            <div className="relative aspect-[21/9] min-h-[180px] w-full overflow-hidden bg-[#d1dfdf]/50">
              <img
                src={PARK_ROYAL_RESIDENCE_MEDIA.social}
      ...
      <RevealFadeUp>
        <section className="border-t border-[#1f3a40] bg-[#1f3a40] px-6 py-16 text-white lg:px-10 lg:py-20">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 font-serif text-xl leading-relaxed text-white/95 md:text-2xl md:leading-relaxed">
