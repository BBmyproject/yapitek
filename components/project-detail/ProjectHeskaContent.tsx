...
import { HESKA_MEDIA } from "@/lib/heska-media";
...
const STAT_ICONS: IconType[] = [MdStorefront, MdBusiness];

export async function ProjectHeskaContent() {
  const t = await getTranslations("ProjectHeska");
    ...
    >
      <RevealFadeUp>
        <section
          ...
          aria-labelledby="heska-stats-heading"
        >
          <div className="mx-auto max-w-3xl">
            <h2 id="heska-stats-heading" className="sr-only">
              {t("statsSectionLabel")}
            </h2>
